export default [{
  ...
  desc: "Universitas Muhammadiyah Gorontalo (UMGO)",
  date: "Internship 2025 ~ 2026",
  does: [
    "Provided technical support for campus IT infrastructure.",
    "Assisted with network setup, troubleshooting, and maintenance.",
    "Handled hardware and software issues for staff and institutional systems.",
    "Supported daily IT operations to ensure system reliability.",
  ]
}]
